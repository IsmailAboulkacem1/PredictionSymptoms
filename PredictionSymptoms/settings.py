"""
Django settings for PredictionSymptoms project.
...
SECRET_KEY = 'django-insecure-9zwyluflvlftgp!qrz+$-koeb&j2ys_i(&4_le#ug=9qk9s^_b'
...
ROOT_URLCONF = 'PredictionSymptoms.urls'
...
WSGI_APPLICATION = 'PredictionSymptoms.wsgi.application'
